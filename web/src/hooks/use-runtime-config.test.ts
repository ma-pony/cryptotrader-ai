...
describe('runtime config response decoder', () => {
  ...
  it('strips credential state while retaining plain connection parameters', () => {
    const document = toRuntimeDocument({ system: { active: false }, security: { enabled: false }, market_data: { source_id: 'market', parameters: [] }, llm: { models: {}, gateway_credential_configured: true, gateway_credential_updated_at: null }, signals: { components: [], neutral_threshold: .2, max_target_ratio: 1, atr_stop_multiplier: 2, reward_ratio: 2, hitl_required: false }, risk: {}, execution: { allocation_policy: 'weighted', books: [], connections: [{ id: 'demo', label: 'Demo', adapter_id: 'okx', environment: 'demo', enabled: true, credential_configured: true, credential_updated_at: null, leverage: 1, margin_mode: 'cross', parameters: [{ key: 'sandbox', value: { kind: 'boolean', boolean_value: true } }] }] }, hitl: {}, scheduler: {}, triggers: {}, notifications: {}, infrastructure: {}, observability: {} } as never);
